...
helm install eugenmayer/cert-manager-certificate
```

# Why

Since `Certificate` is a CRD you cannot deploy Cert-Manager via the helm-chart AND also deploy this configuration
